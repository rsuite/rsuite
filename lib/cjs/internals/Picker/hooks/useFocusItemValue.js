...
var useFocusItemValue = function useFocusItemValue(defaultFocusItemValue, props) {
  ...
  var focusCallback = (0, _hooks.useEventCallback)(function (value, event) {
    if (focusToOption) {
  ...
  var getScrollContainer = (0, _hooks.useEventCallback)(function () {
    var menu = (0, _isFunction.default)(target) ? target() : target;
   ...
   */
  var findFocusItemIndex = (0, _hooks.useEventCallback)(function (callback) {
  ...
  var scrollListItem = (0, _hooks.useEventCallback)(function (direction, itemValue, willOverflow) {
  ...
  var focusNextMenuItem = (0, _hooks.useEventCallback)(function (event) {
  ...
  var focusPrevMenuItem = (0, _hooks.useEventCallback)(function (event) {
    findFocusItemIndex(function (items, index) {
  ...
  var focusNextLevelMenu = (0, _hooks.useEventCallback)(function (event) {
  ...
  var focusPrevLevelMenu = (0, _hooks.useEventCallback)(function (event) {
    var nextLayer = layer - 1;
    var nextKeys = getSubMenuKeys(nextLayer);
    if (nextKeys) {
      var _getParent;

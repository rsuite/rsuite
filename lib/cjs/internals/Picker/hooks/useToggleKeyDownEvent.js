...
var useToggleKeyDownEvent = function useToggleKeyDownEvent(props) {
  ...
  var handleToggleDropdown = (0, _hooks.useEventCallback)(function () {
    if (active) {
      handleClose();
      return;
    }
  ...
  var onToggle = (0, _hooks.useEventCallback)(function (event) {
    ...
    if (overlay !== null && overlay !== void 0 && overlay.current) {
       ...
       */
      if (event.key === _constants.KEY_VALUES.BACKSPACE && event.target !== (searchInput === null || searchInput === void 0 ? void 0 : searchInput.current)) {
    ...
    if (event.key === _constants.KEY_VALUES.ESC || event.key === _constants.KEY_VALUES.TAB) {
      handleClose();
    }
...
var _default = exports.default = useToggleKeyDownEvent;
 ...
 */
var getFocusableItems = exports.getFocusableItems = function getFocusableItems(filteredData, props, isSearching) {
 ...
 */
var getActiveItem = exports.getActiveItem = function getActiveItem(focusItemValue, flattenedNodes, valueKey) {
  var nodeData = null;
 ...
 */
var focusNextItem = exports.focusNextItem = function focusNextItem(props) {
 ...
 */
var focusPreviousItem = exports.focusPreviousItem = function focusPreviousItem(props) {
  var focusItemValue = props.focusItemValue,
    focusableItems = props.focusableItems,
    treeNodesRefs = props.treeNodesRefs,
    valueKey = props.valueKey;

...
function (_React$Component) {
  ...
  _proto.renderDropdownMenu = function renderDropdownMenu() {
    ...
    var allData = this.getAllData(); //let filteredData = filterNodesOfTree(allData, item => this.shouldDisplay(item[labelKey]));
  ...
  _proto.renderMultiValue = function renderMultiValue() {
    ...
    return tags.map(function (tag) {
      var _this2$getLabelByValu = _this2.getLabelByValue(tag),
          isValid = _this2$getLabelByValu.isValid,
          displayElement = _this2$getLabelByValu.displayElement;
      ...
      return React.createElement(_Tag.default, {
        ...
        onClose: _this2.handleRemoveItemByTag.bind(_this2, tag)
      }, displayElement);

import UNSAFE_getDataGroupBy, { getDataGroupBy, KEY_GROUP } from '../getDataGroupBy';

describe('[utils] UNSAFE_getDataGroupBy', () => {
  it('Should be grouped by title', () => {
    ...
    const groups = UNSAFE_getDataGroupBy(items, 'group');
  ...
  it('Should be grouped by country.name Using dot.notation syntax', () => {
    ...
    const groups = UNSAFE_getDataGroupBy(items, 'country.name');
  ...
  it('Should be grouped by title and sorted', () => {
    ...
    const groups = UNSAFE_getDataGroupBy(items, 'group', sort);

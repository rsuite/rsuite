...
describe('Cascader', () => {
  ...
  describe('Focus item', () => {
    ...
    it('Should be selected for focus item by Enter key', async () => {
      ...
      // Click directly on the item with value '1'
      userEvent.click(screen.getByRole('treeitem', { name: '1' }));

      // Wait for the value to be selected
      await waitFor(() => {
        expect(screen.getByRole('combobox')).to.have.text('1');
      });

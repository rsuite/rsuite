...
describe('Toggle', () => {
  ...
  describe('onChange', () => {
    ...
    it('Should not call `onChange` callback when disabled', async () => {
    ...
    it('Should not call `onChange` callback when readOnly', async () => {
    ...
    it('Should not call `onChange` callback when loading', async () => {

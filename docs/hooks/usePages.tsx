...
import { Guide, Component, Ecology } from '@/components/icons';
  ...
  return [
    {
      ...
      icon: <Icon as={() => <Guide />} style={{ fontSize: 20 }} />,
      children: [
        {
          group: true,
          id: 'getting-started',
    ...
    },
    {
      ...
      icon: <Icon as={() => <Component />} style={{ fontSize: 20 }} />,
      children: components
    },
    {
      id: 'resources',
      name: locales?.common?.resources,
      icon: <Icon as={() => <Ecology />} style={{ fontSize: 20 }} />,
      children: [
        {
          id: 'templates',

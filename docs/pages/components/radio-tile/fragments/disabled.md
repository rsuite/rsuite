...
const App = () => (
  <RadioTileGroup defaultValue="private" aria-label="Visibility Level">
    <RadioTile icon={<Icon as={VscLock} />} label="Private" value="private" disabled>
    ...
    <RadioTile icon={<Icon as={VscWorkspaceTrusted} />} label="Internal" value="internal" disabled>
      The project can be accessed by any logged in user except external users.
    </RadioTile>

    <RadioTile icon={<Icon as={VscRepo} />} label="Public" value="public" disabled>

...
| defaultValue       | [ValueType][value]                                                                              | Default value (uncontrolled)                            |
| disabled           | boolean                                                                                         | Whether the component is disabled                       |
| disabledItemValues | [ValueType][value][]                                                                            | Values of disabled items                                |
...
| renderValue        | (value: [ValueType][value], item: [ItemDataType][item], selectedElement:ReactNode) => ReactNode | Custom render function for selected value               |
...
| value              | [ValueType][value]                                                                              | Current value (controlled)                              |

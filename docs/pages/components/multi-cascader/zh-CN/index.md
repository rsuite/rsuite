...
| onCheck               | (value: string, item: [Option][item], checked: boolean, event) => void                    | 当复选框状态变化时触发的回调函数。             |
...
| onSelect              | (item: [Option][item], selectedPaths: [Option][item][], event) => void                    | 当选中某个选项时触发的回调函数。               |
| open                  | boolean                                                                                   | 是否打开组件。                                 |

...
| onCompletion       | (completedFiles: [FileType][file][], failedFiles: [FileType][file][]) => void                                        | Callback function called when all files in the current upload batch have finished (succeeded or failed)                                                                          |
